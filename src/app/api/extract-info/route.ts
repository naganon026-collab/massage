...
与えられたテキスト（店舗の紹介文やWEBサイトからのスクレイピング結果など）から、「店舗の住所」「電話番号」「LINEなどの連絡・予約用URL」「営業時間」「定休日」を探し、JSON形式で正確に抽出してください。
        ...
        const model = genAI.getGenerativeModel({
            ...
            generationConfig: {
                ...
                responseSchema: {
                    ...
                    required: ["address", "phone", "lineUrl", "businessHours", "holidays"]
                }
            }
        });
