...
const LP_DEMOS: Record<string, Record<string, string>> = {
  beforeafter: {
    instagram: `❄️ 冬の寒さが、お身体に静かに影響している。
...
骨盤の傾きを丁寧に見ながら、
痛みのない姿勢矯正×筋膜リリースで施術すると、
ベッドから起き上がった瞬間、

「…これ、本当に自分の体ですか？嘘みたいに軽い」
...
#肩こり #冬の腰痛 #骨盤矯正 #姿勢改善
#筋膜リリース #整体院 #疲労回復 #上田整体`,
    google: `【冬の「慢性疲労」、感じていませんか？】

冬の乾燥した空気と寒さは、筋肉を硬くこわばらせ、
「毎朝起きるのが辛い」「パソコン作業で肩がピリピリ痛む」というご相談を多くいただきます。

上田整体では、ただ強くもみほぐすのではなく、
身体への負担を抑えながら骨盤から丁寧に整える「全身バランス整体」など、
「これからも痛みの出にくい身体づくり」を重視したメニューをご提案しています。

仕上げには、ご自宅でできる簡単なストレッチもアドバイス。
「マッサージはすぐ戻ってしまうけれど、ここは根本から楽になる」という方に好評です。

まずはお気軽にご相談ください。`,
    line: `こんにちは、上田整体です☕️

「最近、夕方になると肩や首がガチガチになる」「朝から腰が重い」
そんなお声をここ数ヶ月でますます多くいただいています。

当院では、ただ強く揉むのではなく、
痛みの原因となっている骨盤や背骨の歪みにアプローチし、
「これから先も痛みの出にくい身体づくり」を一緒に考えていきます。

冬の寒さでこわばっているお身体に、少しだけ労わりの時間をプレゼントしてみませんか？
...
▶ ご予約・お問い合わせは公式サイトまたはLINEからどうぞ。`,
  ...
  kodawari: {
    instagram: `✦ セラピスト上田の「こだわり」を、少しだけご紹介させてください。

もみほぐし一つとっても、私たちは圧の強さ・アプローチする筋肉の深さまで、お客様一人ひとりのその日の身体の状態に合わせて変えています。

「なんとなく軽くなればいい」ではなく、3ヶ月後も痛みの出にくい身体を保てるかを常に考えながら施術しています💡

院長は国家資格も持ち、豊富な臨床経験をもとに、
デスクワーク世代の方の首・肩・腰に寄り添う根本改善を研究し続けてきました。
骨盤矯正や筋膜リリースなど、年齢やライフスタイルに合わせた提案が得意です。

「ずっとここに通っていてよかった」と言っていただけることが、私たちの一番の励みです✨`,
    google: `【セラピストのこだわりについて】

上田整体では、施術の品質にとことんこだわっています。

施術では、圧の強さ・アプローチポイントをお客様の筋肉の状態に合わせて細かく調整。
国家資格保有のセラピストが、根本原因にアプローチする仕上がりを追求しています。

お客様の「こうなりたい」というイメージと、日常生活での癖や姿勢を丁寧にヒアリングし、
無理のない範囲で長く続けられる身体づくりをご提案いたします。

詳しいメニューや料金は公式サイトをご覧ください。`,
    line: `こんにちは！上田です🌿

「マッサージしたては良いけれど、すぐに痛みが戻ってしまう」「バキバキされるのが怖くて挑戦しづらい」
そんなお悩みをよく伺います。

実は、施術のアプローチを少し工夫するだけで、「身体の軽さ」と「痛みの出にくさ」はかなり変わります。

ご来院の際は、普段のデスクワーク環境や、これまで気になっていたことを遠慮なくお話しください😊
あなたのお身体に合ったベストな方法を一緒に考えましょう。`,
  },
  season: {
    instagram: `🌸 3月、春の訪れとともに「身体のリセット」を考える方が少しずつ増えてきました。

まだ肌寒い日も多いですが、薄着になる季節に向けて、
「姿勢を良くしたい」「冬の間に溜まったむくみを取りたい」というご相談をよくいただきます。

冬の寒さで縮こまった筋肉や骨格をそのままにしておくと、
せっかくの春のお出かけもすぐ疲れてしまうことも…。
...
「どこから診てもらえばいいか分からない」という方も、まずはお気軽にご相談ください。`,
    google: `【春に向けたお身体の準備、できていますか？】

3月は卒業・入学・新生活など、活動的になる機会が増える季節です。

上田整体では、
・春めく季節の自律神経ケア
・冬の寒さで固まった筋肉のリリース
・ライフスタイルに合わせたお家ストレッチ指導
を組み合わせた「春支度プラン」のご相談を承っています。

「まだ痛いというほどではないけれど、少しだるい」というご要望にもお応えします。`,
    line: `こんにちは！上田です🌸

少しずつ日が長くなってきましたね。
「春に向けて、そろそろ身体を整えておきたいな」という方も増えてきました。

姿勢改善のご相談はもちろん、
「まずは日々の疲れをリセットしたい」「よく眠れるようになりたい」といったご相談も大歓迎です😊

あなたのライフスタイルに合ったお身体のケア、一緒に考えましょう✨`,
  },
};
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center pt-[120px] pb-0 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[760px]">
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/25 text-emerald-400 py-1.5 px-4 rounded-full text-[13px] font-medium mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <span className="text-[10px]">✦</span> 整体・マッサージ・鍼灸院に対応
          </div>
      ...
      <section className="py-24 px-6 border-t border-zinc-800/80">
        <div className="max-w-[980px] mx-auto">
          <div className="lp-reveal opacity-0 translate-y-6 transition-all duration-500 ease-out mb-14">
            ...
            <p className="text-base text-zinc-400 max-w-[500px]">上田整体の実際の生成例。パターンと媒体を選んでご確認ください。</p>
          </div>
          ...
          <div className="lp-reveal opacity-0 translate-y-6 transition-all duration-500 ease-out border border-zinc-800 rounded-2xl overflow-hidden bg-zinc-900/50">
            <div className="px-6 py-5 border-b border-zinc-800 flex items-center justify-between">
              <span className="text-[13px] text-zinc-400">生成完了 — 上田整体（長野県）</span>
  ...
  const getEpisodePlaceholder = (patternId?: string) => {
    ...
    if (patternId === "A" && selectedTreatment) {
      const examples: Record<string, string> = {
        massage: "長年背中の張りに悩んでいたお客様でしたが、1回の施術で『羽が生えたみたい！』と驚いてくださいました",
        pelvis: "いつも同じ方を組んでしまうというお悩みでしたので、骨盤の歪みを整えたらまっすぐ座れると大正解でした！",
        dry_head_spa: "最近よく眠れないとお悩みでしたが、ヘッドスパ中からぐっすり眠られ、お顔のむくみも取れてスッキリされていました",
        neck_shoulder: "毎朝首の痛みで起きていたそうですが、これからは起きてすぐ動けると大喜びでした",
        fascia_release: "蓄積したコリで腕が上がらない状態からスムーズに動くように復活してずっと驚かれていました",
        foot_care: "夕方にはパンパンになる足が、帰りには靴が緩く感じるほどスッキリし、冷えも改善されたとのことです",
        oil_massage: "日々のストレスがひどい整体院ジプシーだったそうですが、『ここなら通える』と次回予約をいただきました",
        maternity: "産後の腰痛で抱っこが辛いとおっしゃっていましたが、痛みが和らぎ育児がグッと楽になったそうです",
        face_correction: "食いしばりによるエラ張りが気になるとのことで、顔周りをすっきり見せる小顔矯正で大満足いただけました",
        posture_correction: "猫背で老けて見えるのが悩みとおっしゃっていましたが、胸が開いて若々しい印象になり最高の笑顔でした",
        sports_massage: "大事な大会の前にコンディショニングでご来店。可動域が広がり良い記録が出そうと自信を持って向かわれました",
        autonomic_nerve: "気象病で頭痛がひどいとお悩みでしたが、自律神経調整で薬を飲む回数が減ったと報告を受けました",
        acupuncture: "どこに行っても治らなかった深刻な腰痛でしたが、奥のコリにアプローチしてついに痺れが取れました",
        quick_care: "とにかく忙しくてケアに時間を割けない！という方に、15分でスッキリする手技をご提案しました"
      };
      return `（例）${examples[selectedTreatment] || "仕上がりを見て「こんなに軽くなるの!?」と驚いてくれた / 長年腰痛で悩まれていたご新規様でした"}`;
    }

    // B: 教育
    if (patternId === "B" && selectedEducation) {
      const examples: Record<string, string> = {
        ng_posture: "実はお客様の7割が良かれと思ってこのNG姿勢をやってしまっています。私も昔はそうでした…",
        stretch_mistake: "『なんで伸びないの？』とよく聞かれますが、実は痛いところまで伸ばすのは逆効果なんです",
        season_care: "この時期になると急にギックリ腰やむくみの相談が増えます。季節の変わり目にはこんなケアが必須です！",
        smartphone_neck: "最近頭痛や目の疲れが気になるとご相談を受けました。実はこれ、スマホ首が原因かもしれません",
        compress_choice: "せっかくマッサージに行ってもすぐ痛みが戻るという相談を受け、湿布との違いを徹底的にお伝えしました",
        good_sleep: "『寝ても寝ても眠い』というお客様が多いのですがこれは自律神経の乱れかもしれません！",
        swelling_care: "夕方にむくんでしまうという方へ。実はふくらはぎのポンプ機能を高めるだけで全然違うんです",
        breathing: "マッサージの仕上がりを家でキープできない！というお悩みを解決するため、絶対に失敗しない深い呼吸法をまとめました",
        salon_timing: "『どれくらいの頻度で通えばいいの？』など、実はお客様からよく聞かれる整体通いの真実をお答えします",
        after_care: "月に1回のプロのケアよりも残り29日のホームケアが身体を決めます。今日からできる最強ツールのご紹介です",
        pelvis_distortion: "『気がつくと脚を組んでいる』そんな歪みから解放される選択肢があることをもっと知ってほしいです",
        water_intake: "極端な水分不足だと、真っ先に筋肉が固くなってしまいます。巡りを良くする簡単な飲み方をご紹介します",
        pain_hidden: "高級な湿布を貼っても数日で元通りになってしまう…そんな負のループから抜け出すための本質的なお話です",
        strong_massage: "『とにかく強く揉んで！』が実は危険。無理に痛めつけなくていい、本当に効く適圧の必要性を語ります",
        sports_injury: "『運動前にストレッチした方がいいの？』というよくある質問に、競技と目的に合わせてお答えします！",
        maternity_care: "産後に突然腰の痛みや骨盤のグラつきが気になり始めた方へ。これは我慢しなくていいサインかもしれません"
      };
      return `（例）${examples[selectedEducation] || "最近お客様から本当によく相談される内容です / 実は私自身も過去によく痛めてしまっていました…"}`;
    }
    ...
    if (patternId === "C" && selectedNoticeType) {
      const examples: Record<string, string> = {
        ...
        new_menu: "私が半年間、自分の身体で何度もテストして『これだ！』と確信した最強の手技をついに皆様にお届けできます",
        new_product: "発売前から話題沸騰だったあのケア用品、やっと当院にも入荷しました！スタッフも全員自腹で買うほどの実力派です",
        holiday: "誠に勝手ながらお休みをいただきます。しっかりリフレッシュして、さらにパワーアップして皆様をお迎えします！",
        event: "ご来院いただいた皆様にささやかながら特別なギフトをご用意しています。日頃の感謝を伝えさせてください",
        staff_schedule: "セラピスト〇〇の来月の出勤予定です。〇日と〇日はお休みをいただいておりますのでご注意ください",
        staff_activities: "昨日は定休日を利用して、スタッフ全員で解剖学の講習会に参加し、技術をアップデートしてきました！",
        hiring: "業務拡大に伴い、一緒に院を盛り上げてくれる整体スタッフを1名募集することになりました",
        booking_status: "大変ありがたいことに、来週末のご予約がほぼ満席となっております。ご希望の方はお早めに！",
        price_revision: "大変心苦しいですが、〇月〇日より一部整体メニューの価格を改定させていただきます",
        cancellation_policy: "いつもご来院ありがとうございます。最近当日キャンセルが増えておりますため、改めて規定についてご案内です",
        shop_info: "お店の裏にある提携駐車場が2台増えました！お車でお越しのお客様はぜひご利用ください",
        media_appearance: "なんと！今月発売の〇〇という雑誌で、当院の骨盤矯正メニューが見開きで紹介されました！",
      };
      return `（例）${examples[selectedNoticeType] || "週末のご予約はすぐ埋まりやすいのでお早めに！ / この機器は私が半年かけて探し出した究極のケア用品です"}`;
    }

    // D: お客様の声
    if (patternId === "D" && selectedVoiceOption) {
      const examples: Record<string, string> = {
        v_massage: "（例）『全身の重さが嘘みたい！』と嬉しそうに何度も肩を回している姿がとても印象的でした",
        v_pelvis: "（例）『初めて自分にピッタリの姿勢改善に出会えました』と、帰る時には来た時より表情まで明るくなっていました",
        v_neck_shoulder: "（例）『頭痛が憂鬱じゃなくなりました！朝の準備が本当に楽です』というご報告をいただき私もとても嬉しくなりました",
        v_dry_head_spa: "（例）『久しぶりに朝までぐっすり眠れました！』と次回予約の際におっしゃっていただけました",
        v_posture: "（例）『呼吸が深くなったのは初めての感覚です！』と大絶賛していただけました",
        v_foot_care: "（例）帰り際、何度もご自身の靴を履き直して『緩くなってる！』と感動してくださったのが最高の瞬間でした",
        v_maternity: "（例）『産後の我慢しかなかった痛みが取れて育児が楽しいです』と涙ぐんでお話してくださいました",
        v_face: "（例）『顔周りを少し変えてもらっただけで、整形級に雰囲気が変わってビックリ！』と大絶賛していただけました",
        
        v_pain_gone: "（例）『もう手術しかないと諦めていたのにここまで回復するなんて』と驚きと感謝の言葉をいただきました",
        v_sleep_well: "（例）『寝起きのすっきり感が全く違います！』と感動のメッセージをいただきました",
        v_posture_better: "（例）『帰った後、職場の同僚に「すごく若返ったね！」と褒められました！』とLINEでわざわざご報告をくださいました",
        v_body_light: "（例）『常に背負っていた鉛が取れたみたいです』と最高の笑顔をいただきました",
        v_can_move: "（例）『諦めていたテニスがまたできるようになりました』という素敵なエピソードをいただきました",
        v_trusting: "（例）『バキバキされるのが怖かったけど、痛みのない施術で安心しました』と安心して任せていただけました",
        v_mental_health: "（例）『長年しっくりくる整体院がなく転々としていましたが、やっと「ここだ！」と思える場所に運命的に出会えました』"
      };
      return `（例）${examples[selectedVoiceOption] || "「朝の目覚めがすっきりして身体が軽い」と喜んでいただけました / 帰り際の元気な笑顔が忘れられません"}`;
    }

    // E: メッセージ
    if (patternId === "E" && selectedMessage) {
      const examples: Record<string, string> = {
        commitment: "全工程の中で私が一番こだわっているポイントと、他の整体院様との決定的な違いについて",
        episode: "先日ご来院いただいたお客様が、帰り際に痛みが取れたと涙ぐんでくださった時の話",
        why_therapist: "実は私、昔は自分自身の腰痛が本当にコンプレックスで色々な治療院に通っていたんです。",
        skill_growth: "先日、新しい筋膜リリースの講習会に参加してきました！現状に満足せず常に技術を磨き続ける理由。",
        customer_first: "痛みを取るのはもちろん「ここに来てよかった」と心からリフレッシュして帰っていただきたいです",
        consultation: "当院が初回カウンセリングに20分かける理由。「原因がわからず不安だった」経験はありませんか？",
        tools_love: "「え、そんなに違うの？」とよく驚かれますが、使うベッドやマットによって身体の脱力感は劇的に変わるんです",
        product_obsession: "絶対に妥協したくなくて、私の体で何十種類も「人体実験」をした結果、ようやく辿り着いた最強のオイルです",
        past_failure: "修業時代、一番指名が取れなかった私が今技術を教える立場になって気付いた大切なこと",
        honest_request: "整体師からの切実なお願い。これだけは絶対に避けてほしい「NGな日常動作」について",
        private_insight: "お休みの日の筋トレが、実はお客様へのホームケア指導の絶妙な引き出しに繋がっていたりします",
        future_vision: "5年後、この院をどんな場所にしたいか。私たちが目指している『ただの整体院ではない場所』"
      };
      return `（例）${examples[selectedMessage] || "なぜ私がこの手技にここまでこだわるのか、今日は少しだけ語らせてください"}`;
    }

    // H: 日常シーン
    if (patternId === "H" && selectedScene) {
      const examples: Record<string, string> = {
        preparation: "お客様がご来院される前にその日のカルテを見直して完璧な状態にセッティングする毎朝の静かな時間が好きです",
        study: "営業後のレッスン風景。新しい骨盤調整のアプローチをミリ単位で検証し、スタッフ同士で熱く議論が交わされています！",
        new_product: "待ちに待った念願の最新電気治療機材が到着！早速実験してみたら想像以上の効果に院内が騒然となりました",
        customer_voice: "今日いらした常連様から『ここの整体が一番癒される的確だ』と言っていただきスタッフの〇〇が嬉し泣きしていました",
        morning_open: "朝一番の澄んだ空気の中、観葉植物に水をやりながらお客様をお迎えする準備を整える。今日も一日頑張ります！",
        team: "休憩時間の一コマ。みんなで新作のアイスを食べながら先日のセミナーの振り返りで持ちきりです！",
        season_deco: "クリスマスに向けて院内を飾り付け。〇〇を中心にどこかアットホームでワクワクする空間が完成しました！",
        tool_care: "一日の終わりに相棒のベッドや機器を除菌する時間。この空間でお客様を笑顔にできることが何よりの誇りです"
      };
      return `（例）${examples[selectedScene] || "新しく導入した最新の筋膜リリース機器、スタッフ全員で試して大興奮！ / いつも来てくださる常連のお客様から素敵な差し入れをいただきました"}`;
    }

    switch (patternId) {
      case "A": return "（例）仕上がりを見て「こんなに変わるの!?」と涙ぐんで喜んでくれた / 長年しつこい腰痛で悩まれていたご新規様でした";
      case "B": return "（例）最近お客様から本当によく相談される内容です / 実は私自身も過去によく痛めてしまっていました…";
      case "C": return "（例）お陰様で週末のご予約はすぐ埋まりやすいのでお早めに！ / 実はこのメニュー、私が半年かけて探し出した自慢のメニューです";
      case "D": return "（例）「朝の目覚めがすっきりして身体が軽い」と喜んでいただけました / 帰り際の最高の笑顔が忘れられません";
      case "E": return "（例）担当スタッフ：〇〇 / なぜ私がこの技術にここまでこだわるのか、今日は少しだけ語らせてください";
      case "H": return "（例）新しく導入したリリース機器、スタッフ全員で試して大興奮！ / いつも来てくださる常連のお客様から素敵な差し入れをいただきました";
